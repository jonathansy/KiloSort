function [ops, dd] = config_file_fun(location, kiloDir, dd)
	...
	ops.fbinary             = [location filesep 'full_dataset.dat']; % will be created for 'openEphys'
	ops.fproc               = [location filesep 'temp_wh.dat']; % residual from RAM of preprocessed data
	ops.root                = location; % 'openEphys' only: where raw files are
	...
	ops.chanMap             = [location filesep 'chanMap.mat']; % make this file using createChannelMapFile.m
	...
	dd                  = load([kilodir filesep 'configFiles' filesep 'PCspikes2.mat']); % you might want to recompute this from your own data
